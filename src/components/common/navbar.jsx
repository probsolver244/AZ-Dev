...
const Navbar = () => {
  ...
  // Remove 'isProtected' and 'showAfterLogin' props before passing to Menu
  const filteredNavItems = navItems.map(({ isProtected, showAfterLogin, ...item }) => item); // <-- Change 1
    ...
    <header className="border-b border-gray-300">
      <div className="container mx-auto mt-3">
        <Menu
          ...
          items={filteredNavItems} // <-- Change 2
