...
from .views import StartGameView,GameCreateView, GameListCreateView, GameRetrieveUpdateDestroyView,GameListView, JoinGameView
from .views import AcceptJoinRequestView

urlpatterns = [
    path('start-game/<int:game_id>/', StartGameView.as_view(), name='start-game'),
